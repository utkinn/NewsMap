...
public sealed class AuthController : ControllerBase
{
    ...
    public AuthController(IOptions<JwtOptions> jwtOptions, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
    {
    ...
    public async Task<IActionResult> GenerateToken(AuthRequest authRequest)
    {
        ...
        {
            await _userManager.CreateAsync(new IdentityUser("admin"), "Admin12345!");
        }
